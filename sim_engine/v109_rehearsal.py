...
def rehearse_v109(repo_root: str | Path) -> dict:
    ...
    return {"ok":True,"source_seq":base_seq,"source_head":old_head,"world_minute":t0,"stale_last_turn_pending_ids":stale_ids,"authoritative_pending_ids":current_pending,"sanitized_last_turn_pending_ids":[],"borga_memories_preserved":len(memories0),"last_gameplay_turn_preserved":True,"replay_hash":final_hash}
