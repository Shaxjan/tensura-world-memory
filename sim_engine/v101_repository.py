...
from v101_seed import seed_world_v101_migration


def validate_runtime_pointer_v101(pointer: dict) -> None:
    ...
    if pointer.get("engine_version") not in {"1.0", "1.0.1"}:
