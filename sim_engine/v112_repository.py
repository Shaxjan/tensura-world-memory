...
def validate_runtime_pointer_v112(pointer: dict) -> None:
...
def load_repository_runtime_v112(repo_root: str | Path, db_path: str | Path):
    ...
    world = seed_world_v112_migration(db_path)
